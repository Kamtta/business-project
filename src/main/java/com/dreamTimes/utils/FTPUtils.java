...
public class FTPUtils {
    ...
    private static final String  FTPIP=(String)PropertiesUtils.getKey("ftp.server.ip");
    private static final String  FTPISER=(String)PropertiesUtils.getKey("ftp.server.username");
    private static final String  FTPPASSWORD=(String)PropertiesUtils.getKey("ftp.server.password");
